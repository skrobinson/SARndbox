...
class WaterRenderer: public GLObject {
  ...
  private:
    ...
    unsigned int
    waterGridSize[2]; // Size of cell-centered water level grid; one cell larger than bathymetry grid
    ...
    PTransform
    tangentGridTransform; // Transposed tangent plane transformation from grid space to world space
